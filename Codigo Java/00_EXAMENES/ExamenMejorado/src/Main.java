...
//
            switch (Integer.parseInt(seleccionMenu)) {
                case 1 -> {
                    ...
                    /*
                     Llamar a este método inicia una reacción en cadena,
                     va llamando a otros hasta introducir en la lista de préstamos
                     asociados al libro que buscamos.
                     1 ≥ Dentro de biblioteca le pasamos 3 parámetros.
                     2 ≥ En el método 'alquilarLibro' comprobar que ese libro exista
                     3 ≥ Si dentro de 'alquilarLibro' ese libro existe llamamos a 'BuscarLibroParaAñadirPréstamo'
                     4 ≥ Aquí recorremos el arrayList hasta que coincida el título y entonces añadimos a la arrayList
                     del propio libro cada prestamo a traves del metodo de la clase 'LibroOcio'
                     llamado 'AñadirPrestamoALibro'
                     */

                    bibliotecaPrestataria.alquilarLibro(fechaIPrestamo,dniUsuario,tituloLibroAlquilado);
